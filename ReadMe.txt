...
Ejecutar la siguiente instrucción (en CMD): npm install -g serve Para instalar la herramienta nmp de Noje Js
Dirigirse a la dirección en la que se encuentra el proyecto (por lo general en: C:\Users\Nombre_de_Usuario_Actual\Downloads\Woodstock_concert).
Ejecutar la instrucción (en CMD): serve.
En el navegador de su preferencia abrir la siguiente dirección: localhost:Puerto_Asignado_En_El_Paso_Anterior (por lo general 3000 ó 5000).
